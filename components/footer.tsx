        ...
        <div className="relative w-full mx-auto justify-between flex-col bg-neutral-100 border-t-2 border-orange-100">
            ...
            <div className="grid-cols-3 flex  px-10 py-10 mx-10 justify-center" >
                <div className="item-center flex flex-col col-span-2 pr-10">
                    <Image src={"/icon.png"} alt="logo" height={110} width={140}  ></Image>
                </div>
                <div className=" items-center col-span-1 px-20">
                    ...
                    <ul className="list-none text-neutral-400 text-sm ">
                        <li className="mb-1"><Link href={"localhost:3000/works"}>Works </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000/works"}>Agency </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000/works"}>About </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000/works"}>Case Studies </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000/works"}>Pricing </Link></li>
                    </ul>

                </div>
                {/* <div className=" items-center col-span-1 px-10">
                    <h3 className=" text-neutral-500 mb-3 mt-2">Follow Us</h3>
                    <ul className="list-none text-neutral-400 ">
                        <li className="mb-1"><Link href={"localhost:3000"} className="flex flex-row">
                        <FaFacebook className=" h-5 w-5"/> 
                        <span className="mx-2">Facebook</span> </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000"} className="flex flex-row">
                        <FaInstagram className=" h-5 w-5"/> 
                        <span className="mx-2">Instagram</span> </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000"} className="flex flex-row">
                        <FaTwitter className=" h-5 w-5"/> 
                        <span className="mx-2">Twitter</span> </Link></li>
                        <li className="mb-1"><Link href={"localhost:3000"} className="flex flex-row">
                        <FaLinkedin className=" h-5 w-5"/> 
                        <span className="mx-2">LinkedIn</span> </Link></li>
                    </ul>
